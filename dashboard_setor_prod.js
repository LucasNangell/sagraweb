...
createApp({
    setup() {
        ...
        // Fetch Data from Real API (PCP-first)
        const fetchData = async () => {
            ...
            try {
                ...
                if (result && Array.isArray(result.items) && result.items.length > 0) {
                    ...
                    console.warn('Fila PCP vazia ou formato inesperado — ativando fallback padrão');
                ...
                try {
                    ...
                    console.error('Falha no fallback do painel', fallbackErr);
                }
            }
