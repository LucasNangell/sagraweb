...
def start_server(name):
    ...
    try:
        # Redirecionar logs para arquivos individuais para debug
        log_file_path = f"logs/{name.lower()}_std.log"
        ...
        # Aguardar inicialização (evita falso positivo de "caiu" e erro de porta em uso)
        if p_type == "web":
            time.sleep(5)
